  ...
  <div class="row">
    ...
    <nav class="col-md-3 col-lg-2 d-md-block sidebar p-3">
      ...
      <div class="nav flex-column nav-pills">
		...
		<a href="#" class="nav-link" data-section="pages/mods">🛠️ Mods</a>
		<a href="#" class="nav-link" data-section="pages/administradores">🧑‍💻 Administradores</a>
		<a href="#" class="nav-link" data-section="pages/control_usuarios">👥 Control de Usuarios</a>
		<a href="#" class="nav-link" data-section="pages/usuarios">🧟 Usuarios Online</a>		
		<a href="#" class="nav-link" data-section="pages/estadisticas">📊 Estadísticas</a>
		<a href="#" class="nav-link" data-section="pages/telnet_console">🖥️ Consola Telnet</a>
        <a href="#" class="nav-link" data-section="pages/respaldos">🗂️ Respaldos</a>
		<a href="#" class="nav-link" data-section="pages/logs">📜 Logs</a>
        <a href="#" class="nav-link" data-section="pages/actualizacion">🔄 Actualización</a>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="main">
      <div class="text-center p-5 text-light">
        👋 Bienvenido al Panel de Administración de 7 Days to Die
      </div>
